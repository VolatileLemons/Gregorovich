...
class general(commands.Cog, name="general"):
    ...
    async def botinfo(self, context: SlashContext):
        ...
        embed.add_field(
            name="Prefix:",
            value=f"{config['bot_prefix']} (most commands arent hooked to it anymore)",
            inline=False
        )
        embed.set_footer(
    ...
    async def server(self, context: SlashContext):
        ...
        embed = discord.Embed(
            description=f"Join the support server for the bot by clicking [here](https://discord.gg/Y9UwqEACkn).", #https://discord.gg/mTBrXyWxAF).",
            color=0xD75BF4
        )
        try:
